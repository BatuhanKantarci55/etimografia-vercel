...
const kvkkData = require("@assets/data/legal/kvkk.json");
...
export default function KVKKModal({ visible, onClose }: Props) {
      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          >
            ...
            {kvkkData.sections.map((section: any, index: number) => (
